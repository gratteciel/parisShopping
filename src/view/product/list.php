    ...
    <a href="index.php?page=article&id=<?php echo $productInfo['idArticle']; ?>" >
        <div class="produit card" style="width: 30%;color:black;" >
            ...
            <div class="card-body">
                ...
                <?php else : ?>
                    <p class="card-text" style="margin:0px;">Date de début : <?php echo $productEnchereSelonId[$productInfo['idArticle']]['dateDebut']; ?></p>
                    <p class="card-text" style="margin-top:0px;">Date de fin : <?php echo $productEnchereSelonId[$productInfo['idArticle']]['dateFin']; ?></p>
                <?php endif; ?>

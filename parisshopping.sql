...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 09 déc. 2021 à 21:10
...
(1, '8', 'villa Caroline', 'Voisins', 78960, 'BUET-ELFASSY', 4, 'France'),
(18, '12', 'rue OUI', 'Lyon', 69000, 'Vincent', 4, 'France'),
(17, 'f', 'f', 'f', 23, 'f', 11, 'f'),
(16, '', 'f', 'f', 1, 'f', 4, 'f'),
(15, '10', 'villa', 'Voisins', 78960, 'RAVEL', 4, 'France'),
(19, 'd', 'd', 'd', 2, 'd', 4, 'd'),
(20, '', 'xx', 'd', 7, 'z', 4, 'd');
...
(18, 'Travaillez où que Vous Soyez : Vous profitez d\'un contrôle précis du curseur, quel que soit l\'endroit où vous utilisez votre trackball. Les tables massives, les canapés confortables et les lits moelleux ne représentent aucun obstacle pour le trackball M570 !', 150, 0, '2021-12-08 20:22:35', 2, 'Logitech M570 sans fil Trackball', 'rare'),
...
(3, 'Processeur Intel de dernière génération, possédant 10 coeurs et intégrant la technologie hybride.', 80, 0, '2021-12-08 10:11:36', 2, 'Intel Core I5', 'régulier'),
(4, 'Processeur Intel de 12e génération, comportant 12 coeurs, de fréquence max 5GHz. Pour ceux qui veulent de la vitesse d\'exécution.', 75, 0, '2021-12-08 10:49:34', 2, 'Intel Core I7', 'haut de gamme'),
(5, 'La rolls des processeurs. Processeur 16 coeurs, sans aucune concession. Attention cet article est rare, les quantités sont limitées!', 10, 0, '2021-12-08 11:04:06', 6, 'Intel Core I9', 'rare'),
...
(8, 'Supprimez tous les obstacles sur le chemin de la victoire grâce à la souris PRO la plus légère et la plus rapide jamais produite. Souris conçue pour les habiles du poigné.', 75, 0, '2021-12-08 15:22:51', 6, 'Logitech PRO X', 'haut de gamme'),
...
(13, 'PC haut de gamme en série limitée, processeur Intel Core I9, 32 Go de RAM, Nvidia RTX 3080, SSD 2 To. Pour ceux qui en ont les moyens, ce PC est un produit rare, dépêchez-vous!', 3, 0, '2021-12-08 16:09:45', 6, 'MSI Gaming GE66 Raider', 'rare'),
...
(1, 'MasterCard', '1111222233334444', 'Mathis BUET-ELFASSY', '2021-12-10', '245', 4);
